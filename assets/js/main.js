...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const scrollDelay = 1500; // Increased delay between scrolls
    const animationDuration = 1200; // Longer animation duration
...
$(document).on("click", function (e) {
  ...
  if (
    ...
    !$(e.target).hasClass("open-offcanvas")
  ) {
    offcanvas.removeClass("show");
